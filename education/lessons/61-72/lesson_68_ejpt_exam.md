...
**Топология:**
- Основной вариант для 8GB RAM: встроенный timed mock exam transcript из этой лекции.
- Cloud lab/AttackBox/Pwnbox: углубление, если есть отдельный доступ и правила площадки.
...
1. **Timed Challenge**: поставьте таймер на 2 часа и пройдите встроенный mock exam transcript: recon notes, web finding, auth observation, privilege escalation risk card, report summary. Запишите время на каждом этапе.

2. **Exam readiness review**: по встроенной рубрике урока составьте список “Top 10 preparation risks”: какие темы проседают, какие labs нужны и какие evidence-привычки нужно усилить.

3. **Техническая подготовка**: по встроенным worksheets убедитесь, что вы умеете:
...
3. **Опора только на внешние платформы** — текущий курс должен давать readiness baseline сам по себе; внешние labs нужны для скорости и экзаменационной привычки, но не заменяют отчетность, triage и safe boundaries.
