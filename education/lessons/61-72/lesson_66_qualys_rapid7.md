...
Книги курса использованы автором как источники для построения этой лекции, но не как обязательное домашнее чтение. Студенту не нужно искать недостающую теорию в отдельных файлах или внешних материалах: все понятия, команды, ограничения, безопасные примеры, ожидаемые результаты и критерии сдачи для темы `Занятие 66. Qualys / Rapid7: видеообзоры, документация` должны быть понятны из текущего урока.
...
### 1. Предмет урока: Занятие 66. Qualys / Rapid7: видеообзоры, документация
...
### 2. Модель и границы: видеообзоры, документация
...
### 3. Ключевые понятия: видеообзоры, документация
...
### 4. SDET-практика: видеообзоры, документация
...
### 7. Типичные ошибки: видеообзоры, документация
