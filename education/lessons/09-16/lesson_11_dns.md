...
> **⚠️ ВНИМАНИЕ: Легальность.** Все действия в этом уроке выполняются только в учебной лаборатории. Не выполняйте DNS-атаки (DNS spoofing, zone transfer) на чужие домены. Используйте TryHackMe, HackTheBox.
