...
Книги курса использованы автором как источники для построения этой лекции, но не как обязательное домашнее чтение. Студенту не нужно искать недостающую теорию в отдельных файлах или внешних материалах: все понятия, команды, ограничения, безопасные примеры, ожидаемые результаты и критерии сдачи для темы `Занятие 49. TryHackMe (Intro): путь "Complete Beginner"` должны быть понятны из текущего урока.
...
### 1. Предмет урока: Занятие 49. TryHackMe (Intro): путь "Complete Beginner"
...
### 2. Модель и границы: путь "Complete Beginner"
...
### 3. Ключевые понятия: путь "Complete Beginner"
...
### 4. SDET-практика: путь "Complete Beginner"
...
### 7. Типичные ошибки: путь "Complete Beginner"
...
Минимальный эталонный артефакт для сдачи по теме `Занятие 49. TryHackMe (Intro): путь "Complete Beginner"`:
