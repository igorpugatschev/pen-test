...
4. Используйте встроенные mock Shodan banners из урока 38: выберите 5 примеров, классифицируйте риск exposure и не подключайтесь к чужим хостам. Live Shodan остается только углублением.
