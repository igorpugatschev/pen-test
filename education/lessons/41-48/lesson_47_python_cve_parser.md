...
**Уровень прогрессии:** CVE research automation

### Минимум

Используйте скрипт только для публично раскрытых версий компонентов, найденных ранее.

### Практика Slider AI

Сформируйте таблицу `component/version/source/CVE candidates/confidence`.

### Углубление после изучения следующих уроков

После ручной проверки добавьте remediation-рекомендации для подтвержденных совпадений.
