...
**Уровень прогрессии:** Safe QA helper

### Минимум

Соберите мини-инструмент, который делает только headers/status/link inventory для Slider AI.

### Практика Slider AI

Добавьте allowlist, timeout, rate limit, JSON/Markdown output и маскирование cookies/tokens.

### Углубление после изучения следующих уроков

После урока 63 используйте вывод инструмента как приложение к отчету.
