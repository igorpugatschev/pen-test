...
Локальный TCP helper проверяет только `127.0.0.1` или явно разрешенную lab-цель. Его задача — научить SDET понимать сетевую проверку на уровне кода, но не превращать скрипт в сканер реальных доменов.
