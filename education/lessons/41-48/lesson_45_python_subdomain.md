...
После SDET-курса студент умеет строить надежные клиенты и обрабатывать данные. Здесь задача — собрать passive inventory из уже известных источников/списка, не запускать словарный перебор по продукту без отдельного approval.
